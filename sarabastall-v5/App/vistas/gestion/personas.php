...
<div id="ventanaModal" class="modalJS">
    <div class="contenido-modal">
        ...
        <br>
        <hr>
        <form method="post" action="<?php echo RUTA_URL ?>/master/add_persona">
            <label>Nombre:</label>
  ...
  <div class="modal-dialog modal-dialog-center"> 
      <div class="modal-content">
          ...
          <div  class="modal-footer"> 
              <form method="post" id="formCerrarAccion" action="<?php echo RUTA_URL ?>/master/eliminarPersona">
  ...
  <tbody id="tbody">
    <?php foreach ($datos["PersonasTotales"] as $persona): ?>
      <tr>
        ...
        <td>
          <!--Aqui van 2 botones-->
          <a href="<?php echo RUTA_URL ?>/master/verPersona/<?php echo $persona->Id_Persona ?>">
