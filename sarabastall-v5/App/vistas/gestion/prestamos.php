  ...
  <div class="modal-dialog modal-dialog-center"> 
      <div class="modal-content">
          ...
          <div  class="modal-footer"> 
              ...
              <input type="hidden" id="Id_Eliminar" name="id_prestamoA">
      ...
      <tr>
        ...
        <td>
          <?php if($prestamo->Id_Estado == 1): ?>
            <strong class="text-secondary"><?php echo $prestamo ->NombreEst  //O tambien de color de texto muted
          ?>
          <?php elseif($prestamo->Id_Estado == 2): ?>
            <strong class="text-dark"><?php echo $prestamo ->NombreEst?>
          <?php endif ?>

          <?php if($prestamo->Id_Estado == 5): ?>
            <strong class="text-success"><?php echo $prestamo ->NombreEst?>
          <?php endif ?>

          <?php if($prestamo->Id_Estado == 6): ?>
