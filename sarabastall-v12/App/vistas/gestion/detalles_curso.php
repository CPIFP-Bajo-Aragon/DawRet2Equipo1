...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="<?php echo RUTA_URL ?>/admin/index">Home</a></li>
          <li class="breadcrumb-item"><a href="<?php echo RUTA_URL ?>/admin/gestionar_cursos">Gestion Cursos</a></li>
        ...
        <div class="card">
            ...
            <form method="post" class="mb-5">
              <div class="row">
                ...
                <div class="col-4">
                  <a class="w-100 btn btn-danger btn-lg" href="<?php echo RUTA_URL?>/admin/gestionar_cursos">Atras</a>
                </div>
              </div>
            </form>
          </div>
