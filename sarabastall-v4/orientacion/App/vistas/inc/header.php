...
<head>
    ...
    <link rel="stylesheet" href="<?php echo RUTA_URL?>/css/stylus.css">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="<?php echo RUTA_URL?>/../">Orientacion</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <?php if (isset($datos['menuActivo']) && $datos['menuActivo'] == 'home'): ?>
              <a class="nav-link active" aria-current="page" href="<?php echo RUTA_URL?>">Cerrar Sesion</a>
