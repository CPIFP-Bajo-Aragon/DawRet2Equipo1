<?php
    class AsesoriaModelo{
        ...
        public function addAsesoria($datos,$id_profesor){
            $this->db->query("INSERT INTO asesoria (nombre_as, dni_as, titulo_as, telefono_as, email_as, domicilio_as, descripcion_as, fecha_inicio, id_estado)
                                VALUES (:nombre_as, :dni_as, :titulo_as, :telefono_as, :email_as, :domicilio_as, :descripcion_as, NOW(), 1)");
            ...
            $this->db->query("INSERT INTO reg_acciones (fecha_reg, accion, automatica, id_asesoria, id_profesor)
                                        VALUES (NOW(), 'Inicio', 1, :id_asesoria, :id_profesor)");
        ...
        public function cerrarAccion($datos){
            // Cambiamos estado asesoria = 3 -Cerrado-
        ...
        public function asesoriaCerrada($id_asesoria){
            $this->db->query("SELECT * FROM asesoria WHERE id_asesoria = $id_asesoria AND id_estado=3");
