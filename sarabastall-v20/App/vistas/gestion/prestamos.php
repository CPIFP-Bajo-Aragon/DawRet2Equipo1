...
<div class="modal-content">
  ...
  <form method="post" action="<?php echo RUTA_URL ?>/admin/add_prestamo">
    ...
    <div class="mb-3">
        <label for="exampleFormControlInput1" class="form-label">Fecha Concedido Préstamo:</label>
        <input type="date" class="form-control" id="fecha_concedido" name="fecha_concedido">
    </div>
