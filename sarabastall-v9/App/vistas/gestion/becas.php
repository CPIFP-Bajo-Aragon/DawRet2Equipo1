...
<div class="col-3">
    ...
    <button id="JRM" onclick="filtrarTipoBeca1()">JRM</button>
    <button id="CARRERA" onclick="filtrarTipoBeca2()">CARRERA</button>
    <button id="REFUGIO" onclick="filtrarTipoBeca3()">REFUGIO</button>
  </div>
  <br>
