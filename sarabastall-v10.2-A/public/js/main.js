...
let button = document.getElementById("botonCiudad");

let Span = document.getElementsByClassName("cerrarVentana")[0];

button.addEventListener("click", function(){
  modalCiudad.style.display = "block";
});
...
ventana.addEventListener("click", function(event){
  if(event.target == modalCiudad){
    modalCiudad.style.display = "none";
  }
});


//Ventana modal para añadir NUEVOS MOVIMIENTOS
let modalMov = document.getElementById("ModalMovimientos");

let btn = document.getElementById("InsertarMovimientos");
