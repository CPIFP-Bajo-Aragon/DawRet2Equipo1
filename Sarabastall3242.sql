...
-- Tiempo de generación: 13-02-2023 a las 14:06:34
...
INSERT INTO `ALUMNO` (`Id_Persona`, `Curso_Actual`, `Tutor_Legal`) VALUES
(2, 'primero', 'Jose'),
(3, 'tercero', 'JAJAJA');
...
INSERT INTO `BECA` (`Id_Beca`, `Importe`, `Observaciones`, `Fecha_Beca`, `Nota_Media`, `Id_Persona`, `Id_Centro`, `Id_Tipo_Beca`, `Fecha_Financiacion`) VALUES
(2, '2105', 'importe total concedido', '2023-01-16', 6, 2, 3, 3, '2023-02-05'),
(3, '142.65', 'segundo pago al estudiante', '2023-02-05', 8.25, 3, 2, 1, '2023-02-13');
...
INSERT INTO `CENTRO` (`Id_Centro`, `Nombre`, `Cuantia`, `Id_Ciudad`) VALUES
(1, 'CPIFP Bajo Aragon', 115.6, 1),
(2, 'LALALALasdf', 87.45, 5),
(3, 'IES Bajo Aragon', 44.2, 1),
(4, 'Prueba NUmeros', 100.012, 2),
(5, 'Test1', 12.562, 3),
(7, 'dfdfdfdfdf', 3333, 3);
...
INSERT INTO `CIUDAD` (`Id_Ciudad`, `Nombre_Ciudad`, `Distancia`) VALUES
(1, 'Alcañiz', 40),
(2, 'Alcorisa', 58),
(3, 'Valdealgorfa', 150),
(4, 'La Mata de los Olmos', 223),
(5, 'Prueba', 54.25),
(6, 'ajdfadf', 150),
(7, '5hghghg', 44);
...
INSERT INTO `MOVIMIENTO` (`Id_Movimiento`, `Fecha`, `Procedencia`, `Cantidad`, `Id_TipoMov`, `Id_Beca`) VALUES
(1, '2023-02-06', 'Agricultura', 150, 1, NULL),
(2, '2023-02-06', 'Beca JRM', 156, 1, 2),
(3, '2023-02-16', 'Beca JRM', 350, 1, 2),
(6, '2023-02-13', 'Beca Refugio', 425.12, 2, 3),
(7, '2023-02-13', 'Agricultura', 50.26, 2, NULL);
...
(2, 'Lola', 'Lola Lola', 'Calle lola lola,34', '2002-02-01', '666552210', 'lolalolita@gmail.com', NULL, NULL, NULL),
(3, 'Pedro', 'Pedro Pedro', 'calle arriba, 23', '2014-02-13', '695210356', 'pedropedrito@gmail.com', NULL, NULL, NULL);
...
INSERT INTO `TIPO_BECA` (`Id_Tipo_Beca`, `Tipo_Beca`) VALUES
(1, 'Refugio'),
(2, 'Carrera'),
(3, 'Jose Ramon de la Morena');
...
ALTER TABLE `BECA`
  ...
  ADD KEY `BECA_ibfk_3` (`Id_Tipo_Beca`);
...
ALTER TABLE `CURSO`
  ...
  ADD KEY `Id_Movimiento` (`Id_Movimiento`),
  ADD KEY `CURSO_ibfk_4` (`Id_Estado`);
...
ALTER TABLE `PRESTAMO`
  ...
  ADD KEY `Id_Movimiento` (`Id_Movimiento`),
  ADD KEY `PRESTAMO_ibfk_4` (`Id_Estado`);
...
--
ALTER TABLE `BECA`
  MODIFY `Id_Beca` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `CENTRO`
--
ALTER TABLE `CENTRO`
  MODIFY `Id_Centro` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `CIUDAD`
--
ALTER TABLE `CIUDAD`
  MODIFY `Id_Ciudad` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `MOVIMIENTO`
  MODIFY `Id_Movimiento` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `TIPO_BECA`
  MODIFY `Id_Tipo_Beca` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `TIPO_MOVIMIENTO`
--
ALTER TABLE `TIPO_MOVIMIENTO`
  MODIFY `Id_TipoMov` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
ALTER TABLE `CURSO`
  ...
  ADD CONSTRAINT `CURSO_ibfk_4` FOREIGN KEY (`Id_Estado`) REFERENCES `ESTADO` (`Id_Estado`);
...
ALTER TABLE `PRESTAMO`
  ...
  ADD CONSTRAINT `PRESTAMO_ibfk_4` FOREIGN KEY (`Id_Estado`) REFERENCES `ESTADO` (`Id_Estado`);
