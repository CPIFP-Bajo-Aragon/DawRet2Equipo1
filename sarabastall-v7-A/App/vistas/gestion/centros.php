  ...
  <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            <label for="NombreText" class="form-label">Nombre Centro:</label>
            <!-- <div id="Nombre" class="form-text">Introduce el nombre del centro.</div> -->
            <input type="text" class="form-control" id="text" aria-describedby="text">
          </div>

          <label for="NombreText" class="form-label">Nombre Ciudad:</label>
         <select class="form-select" aria-label="Default select example">   <!--  DESPLEGABLE QUE SALGAN TODAS LAS CIUDADES QUE HAY, PARA QUE SELECCIONE UNA -->
...
<div id="container">
<!-- <button type="button" id="anadir" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" href="<?php echo RUTA_URL ?>/centro/addCentro">+</button>  -->
